...
For example, in this picture, I used the arrows to get the ssh command (`ssh cs15lwi22arz@ieng6.ucsd.edu`) [+3], then I typed `"ls"` [+4], and then copy-pasted my password (+6)); this resulted in a total of 13 strokes. 
